 ...
 * Task_NewGameBirchSpeech_StartBirchShucklePlatformFade
 * Task_NewGameBirchSpeech_StartBirchShucklePlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchShuckle
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForShuckle
 * Task_NewGameBirchSpeechSub_WaitForShuckle
...
static void Task_NewGameBirchSpeechSub_WaitForShuckle(u8);
static void Task_NewGameBirchSpeech_StartBirchShucklePlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchShuckle(u8);
...
#define tShuckleSpriteId data[9]
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tShuckleSpriteId;
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForShuckle;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForShuckle(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tShuckleSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchShucklePlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchShucklePlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        gSprites[gTasks[taskId].tShuckleSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tShuckleSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    ...
    {
        FreeAllWindowBuffers();
        FreeAndDestroyMonPicSprite(gTasks[taskId].tShuckleSpriteId);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchShuckle;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchShuckle(u8 taskId)
{
    u8 spriteId;
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        spriteId = gTasks[taskId].tShuckleSpriteId;
        gSprites[spriteId].x = 100;
        gSprites[spriteId].y = 75;
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tShuckleSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tShuckleSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreateShuckleSprite(u8 x, u8 y)
{
    return CreateMonPicSprite_Affine(SPECIES_SHUCKLE, 0, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    shuckleSpriteId = NewGameBirchSpeech_CreateShuckleSprite(100, 0x4B);
    gSprites[shuckleSpriteId].callback = SpriteCB_Null;
    gSprites[shuckleSpriteId].oam.priority = 0;
    gSprites[shuckleSpriteId].invisible = TRUE;
    gTasks[taskId].tShuckleSpriteId = shuckleSpriteId;
