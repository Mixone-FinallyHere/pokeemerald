const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_FIRE_FANG] =
    {
        .effect                = EFFECT_BURN_OR_FLINCH_HIT,
        .power                 = 65,
        .type                  = TYPE_FIRE,
        .accuracy              = 95,
        .pp                    = 15,
    ...
    [MOVE_THUNDER_FANG] =
    {
        .effect                = EFFECT_PARALYZE_OR_FLINCH_HIT,
        .power                 = 65,
        .type                  = TYPE_ELECTRIC,
        .accuracy              = 95,
        .pp                    = 15,
    ...
    [MOVE_ICE_FANG] =
    {
        .effect                = EFFECT_FREEZE_OR_FLINCH_HIT,
        .power                 = 65,
        .type                  = TYPE_ICE,
        .accuracy              = 95,
        .pp                    = 15,
    ...
    [MOVE_SOMNIBITE] =
    {
        .effect = EFFECT_SLEEP_OR_FLINCH_HIT,
        .power = 65,
        .type = TYPE_BUG,
        .accuracy = 95,
        .pp = 15,
