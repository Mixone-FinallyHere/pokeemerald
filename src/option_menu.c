...
#define tTypeEffectiveness data[4]
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tTypeEffectiveness = FlagGet(FLAG_TYPE_EFFECTIVENESS_BATTLE_SHOW);
        ...
        TypeEffect_DrawChoices(gTasks[taskId].tTypeEffectiveness);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_TYPEEFFECT:
            previousOption = gTasks[taskId].tTypeEffectiveness;
            gTasks[taskId].tTypeEffectiveness = TypeEffect_ProcessInput(gTasks[taskId].tTypeEffectiveness);

            if (previousOption != gTasks[taskId].tTypeEffectiveness)
                TypeEffect_DrawChoices(gTasks[taskId].tTypeEffectiveness);
            break;
        case MENUITEM_SOUND:
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gTasks[taskId].tTypeEffectiveness == 0 ? FlagClear(FLAG_TYPE_EFFECTIVENESS_BATTLE_SHOW) : FlagSet(FLAG_TYPE_EFFECTIVENESS_BATTLE_SHOW);
